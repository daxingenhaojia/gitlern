...
typedef struct {
    ...
    CHAR mac[12+1];
	CHAR auz_key[32+1]; //authorize key
...
*  Return: OPERATE_RET
***********************************************************/
OPERATE_RET ws_db_set_user_param(OUT CHAR *data,IN CONST UINT len);
...
*  Return: OPERATE_RET
***********************************************************/
OPERATE_RET ws_db_get_user_param(OUT CHAR **pp_data,IN UINT *len);
