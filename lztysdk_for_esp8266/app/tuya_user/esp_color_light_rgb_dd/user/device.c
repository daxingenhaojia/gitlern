...
#define PWM_4_OUT_IO_MUX PERIPHS_IO_MUX_MTDO_U
#define PWM_4_OUT_IO_FUNC FUNC_GPIO15
#define PWM_4_OUT_IO_NUM 15
...
STATIC BYTE gamma_8_correction[]={0,0,1,1,1,2,2,3,3,4,4,5,6,6,7,7,8,9,9,10,11,11,12,13,13,
        ...
        switch(wf_stat) {
			...
			case STAT_LOW_POWER:
				 ...
				 if(wf_stat == STAT_STA_UNCONN) {
                	...
                	send_light_data(BRIGHT_INIT_VALUE, 0, 0, 0, 0);
                    PR_DEBUG("LOW POWER");
                 }
                 break;
            case STAT_STA_CONN: 
